...
set _DeploySetParametersFile=%RootPath%Mango.Services.ShoppingCartAPI.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%Mango.Services.ShoppingCartAPI.zip" (
echo "%RootPath%Mango.Services.ShoppingCartAPI.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Mango.Services.ShoppingCartAPI.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Mango.Services.ShoppingCartAPI.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%Mango.Services.ShoppingCartAPI.deploy-readme.txt" (
...
start notepad "%RootPath%Mango.Services.ShoppingCartAPI.deploy-readme.txt"
)
echo =========================================================
goto :eof
